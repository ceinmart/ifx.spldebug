...
spldbg_manager() {
    ...
    # O log IBM pode conter dados da rotina: arquivo privado ignorado pelo Git.
    local private_log="$SPLDBG_ROOT/bin/outputs/session-manager-v0.1.0-$(date -u +%Y%m%dT%H%M%SZ)-$$.private.log"
